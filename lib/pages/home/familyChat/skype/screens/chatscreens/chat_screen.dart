...
import 'package:familyApp/pages/home/familyChat/skype/constants/strings.dart';
import 'package:familyApp/pages/home/familyChat/skype/enum/view_state.dart';
...
import 'package:familyApp/pages/home/familyChat/skype/resources/storage_methods.dart';
...
import 'package:familyApp/pages/home/familyChat/skype/utils/call_utilities.dart';
import 'package:familyApp/pages/home/familyChat/skype/utils/permissions.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  emojiContainer() {
    return EmojiPicker(
      ...
      indicatorColor: UniversalVariables.appBarColor,
      rows: 4,
      columns: 7,
      selectedCategory: Category.RECENT,
      noRecommendationsText: "party",
  ...
  Widget senderLayout(Message message) {
    ...
    return Container(
      ...
      child: Padding(
        padding: message.type != MESSAGE_TYPE_IMAGE ? EdgeInsets.all(10) : EdgeInsets.all(0),
    ...
    return CustomAppBar(
      ...
      actions: <Widget>[
        ...
        IconButton(
          ...
          onPressed: () {
            Func.toImplement(context,"To do Phone");
          },
        )
      ],
    );
